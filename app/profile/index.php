...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Requestor &mdash; My Account</title>
  ...
  <body class="profile">
    ...
    <section class="signin-modal" style="margin-top: 4em">
      <h1 class="signin-modal--header">Requestor Profile</h1>
      <p class="">Work-in-progress. This will contain a number of things in the future that allow the user to administrate their account. These include:</p>
      <p><b>Changing password</b>;</p>
      <p><b>Changing account name</b>;</p>
  ...
  function deleteAccount() {
    if (confirm('🚨Are you sure you want to delete your account? Your data will be permanently deleted.')) {
    // Save it!
