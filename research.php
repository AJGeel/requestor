...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    interfaceVariant,
    btnConsent = document.getElementById("consent"),
...
function toNextPage() {
    consent ? location.href = `app/${interfaceVariant}.php` : alert("Unfortunately, we are not allowed to perform this study with persons who do not consent to the terms of this research. \n\nWe urge you to read through the 'Subject information for participation' letter again and decide whether you would like to consent to participating in this study.")
}
